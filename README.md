...
- def getHDual(delta, p, px): allows to compute the dual problem, to be used in finite size. It returns H the lower bound, Lambdas and Rs the Lagrange multipliers and cm, the constant from BFF. 